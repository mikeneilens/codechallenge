...
class MainTest {
    ...
    fun `Test two redeemed or expired vouchers in the incorrect status sequence return the same two vouchers in the correct status sequence`() {
        TestCase.assertEquals("190112:Redeemed:bbbb,190112:Expired:aaaa",sortVouchers("190112:Expired:aaaa,190112:Redeemed:bbbb"))
    }
    ...
    @Test
    fun `Test exmample from the exercise`() {
        TestCase.assertEquals("190111:Activated:ffff,190111:Available:cccc,190112:Activated:bbbb,190112:Available:aaaa,190110:Redeemed:dddd,190110:Expired:eeee",
            sortVouchers("190112:Available:aaaa,190112:Activated:bbbb,190111:Available:cccc,190110:Redeemed:dddd,190110:Expired:eeee,190111:Activated:ffff"))
    }
}